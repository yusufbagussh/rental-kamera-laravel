                ...
                <div class="col-lg-5">
                    <div class="card shadow-lg border-0 rounded-lg bg-transparent">
                        ...
                        <div class="card-body text-white">
                            <form action="/dashboard/categories/{{ $category->kategori_id }}" method="POST" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="mb-3">
                                    <label for="kategori_nama" class="form-label">Nama Kategori</label>
                                    <input type="text" class="form-control @error('kategori_nama') is-invalid @enderror" name="kategori_nama" id="kategori_nama" autofocus value="{{ old('kategori_nama', $category->kategori_nama) }}" required>
                                    @error('kategori_nama')
