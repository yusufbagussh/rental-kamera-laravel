                ...
                <div class="col-lg-5">
                    <div class="card shadow-lg border-0 rounded-lg bg-transparent">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4 text-white">Ubah Data Produk</h3>
                        </div>
                        <div class="card-body text-white">
                            <form action="/dashboard/products/{{ $product->produk_id }}" method="POST" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="mb-3">
                                    <label for="produk_nama" class="form-label">Nama Produk</label>
                                    <input type="text" class="form-control @error('produk_nama') is-invalid @enderror" name="produk_nama" id="produk_nama" autofocus value="{{ old('produk_nama', $product->produk_nama) }}" required>
                                    @error('produk_nama')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('produk_harga') is-invalid @enderror" name="produk_harga" id="produk_harga" value="{{ old('produk_harga', $product->produk_harga) }}" required>
                                    @error('produk_harga')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="produk_keterangan" class="form-control @error('produk_keterangan') is-invalid @enderror" id="produk_keterangan" cols="47" rows="10">{{ old('produk_keterangan', $product->produk_keterangan) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('produk_kategori') is-invalid @enderror" type="text" name="produk_kategori" id="produk_kategori" aria-label="Default select example">
                                        ...
                                        @if (old('kategori_id', $product->produk_kategori) == $category->kategori_id)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('produk_status') is-invalid @enderror"" type="text" name="produk_status" id="produk_status" aria-label="Default select example">
                                        <option selected>Open this select menu</option>
                                        @if (old('produk_status', $product->produk_status) == 'Tersedia')
                                        <option value="Tersedia" selected>Tersedia</option>
                                        <option value="Tidak Tersedia">Tidak Tersedia</option>
                                        @elseif(old('produk_status', $product->produk_status) == 'Tidak Tersedia')
                                ...
                                <div class="mb-3">
                                    <label for="produk_gambar" class="form-label">Gambar Produk</label>
                                    <input type="hidden" name="gambarLama" value="{{ $product->produk_gambar }}">
                                    @if ($product->produk_gambar)
                                    <img src="{{ asset('storage/' . $product->produk_gambar) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                    @else
